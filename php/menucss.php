...
<ul class="menu_color">
        ...
        <li><a href='#'>Gestion CSS</a>
            <ul>
                <li><a href="javascript:;" onClick="window.open('plantillaP.php?css=1','CSS','width=180, height=150, location=0, status=0, resizable=0, scrollbars=0')" style="display:block;color: #B8860B;background-color: #000;">CSS 1</a></li>
                <li><a href="javascript:;" onClick="window.open('plantillaP.php?css=2','CSS','width=180, height=150, location=0, status=0, resizable=0, scrollbars=0')" style="display:block;color:#00bfff;background-color: #ffdead;">CSS 2</a></li>
